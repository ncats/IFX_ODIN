...
from src.input_adapters.pharos_mysql.phipster_adapter import PHIPSTERLegacyLiftAdapter
...
def test_phipster_adapter_reports_registered_legacy_database_version():
