...
# --------------------------------------------------------------------------
def main():
    ap = argparse.ArgumentParser(description="Resolve AREDS metabolites via SRI Name Resolver.")
    ap.add_argument(
        "--input",
        default="AREDS_sig_metabolites.csv",
        help="Input CSV with CHEMICAL_NAME column (default: AREDS_sig_metabolites.csv)",
    )
    ap.add_argument(
        "--output",
        default="AREDS_sig_metabolites_sri.csv",
        help="Output CSV with SRI mappings (default: AREDS_sig_metabolites_sri.csv)",
    )
    ap.add_argument(
        "--log_level",
        default="INFO",
