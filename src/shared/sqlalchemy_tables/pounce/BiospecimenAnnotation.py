...
UniqueConstraint(BiospecimenAnnotation.biospecimen_id, BiospecimenAnnotation.project_id, BiospecimenAnnotation.pounce_annot_key, name='bios_uid_idx')
Index(None, BiospecimenAnnotation.biospecimen_id)
Index(None, BiospecimenAnnotation.project_id)
