...
from src.input_adapters.mysql_pharos.ppi_adapter import ProteinProteinInteractionAdapter
...
protein_protein_interaction_adapter = ProteinProteinInteractionAdapter(pharos_read_credentials)
...
etl_input_list = [
    ...
    protein_protein_interaction_adapter,
]
